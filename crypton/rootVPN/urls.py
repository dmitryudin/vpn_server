...
from .views import email_confirm_view, login_view, registration_view, user_info_view, server_info_view, version_view
...
urlpatterns = [
    ...
    path('api/logout/', user_info_view.UserLogout.as_view(), name='user-login'),
    ...
    path('android/get_version', version_view.AndroidVersionView.as_view(), name='verify_email'), 
    path('ios/get_version', version_view.IosVersionView.as_view(), name='verify_email'), 
